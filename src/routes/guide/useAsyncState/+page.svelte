...
<DocTpl title="useAsyncState">
	<div slot="description">
		<div class="space-y-2">
			<p>
				The useAsyncState hook is designed to simplify the handling of asynchronous operations (like
				API calls) in a reactive way. It:
			</p>
			<ul class="pl-4">
			...
			<ul class="list-disc pl-6">
				<li>
					<Link href="https://vueuse.org/core/useAsyncState"
						>https://vueuse.org/core/useAsyncState</Link
					>
				</li>
			</ul>
		</div>
