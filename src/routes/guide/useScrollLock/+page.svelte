...
<DocTpl title="useScrollLock">
	<div slot="description">
		<div class="space-y-2">
			<p>
				The useScrollLock hook is used to prevent scrolling on a page or a specific element —
				typically by setting overflow: hidden on the target.
			</p>
	...
	<div slot="visual-example">
		...
		<Browser body="p-4 bg-gray-950/50">
			...
			{#if modalOpen}
				<div class="fixed inset-0 bg-gray-950/50 flex items-center justify-center z-10">
					<div class="bg-gray-600 my-2 mx-auto p-4 w-[300px] text-white">
						<p>Modal is open!</p>
						<Button
							on:click={(e) => {
								e.stopPropagation();
