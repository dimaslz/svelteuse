...
<DocTpl title="useStorage">
	<div slot="description">
		<div class="space-y-2">
			<p>It helps avoid repetitive JSON.parse / localStorage.setItem boilerplate and ensures Svelte’s reactivity integrates cleanly with browser storage — even in SSR environments.</p>

			<h3 class="text-lg">Inspired on:</h3>
			<ul class="list-disc pl-6">
				<li>
					<Link href="https://vueuse.org/core/useStorage">
