...
export function useLongPress(
	...
	function isTouch(event: any): event is TouchEvent {
		return typeof TouchEvent !== "undefined" ? event instanceof TouchEvent : "touches" in event;
	}

	function isMouse(event: any): event is MouseEvent {
		return typeof MouseEvent !== "undefined" ? event instanceof MouseEvent : "button" in event;
	}
